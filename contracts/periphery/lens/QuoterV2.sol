...
import '../../core/interfaces/callback/IRabbitSwapV3SwapCallback.sol';
...
contract QuoterV2 is IQuoterV2, IRabbitSwapV3SwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IRabbitSwapV3Pool;
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IRabbitSwapV3Pool) {
        return IRabbitSwapV3Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc IRabbitSwapV3SwapCallback
    function rabbitSwapV3SwapCallback(
        ...
        IRabbitSwapV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IRabbitSwapV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
