...
/// @title NFT positions
/// @notice Wraps RabbitSwap V3 positions in the ERC721 non-fungible token interface
contract NonfungiblePositionManager is
    ...
    SelfPermit
{
    // details about the RabbitSwap position
    struct Position {
    ...
    ) VRC725('RabbitSwap V3 Positions NFT-V1', 'RAB-V3-POS') PeripheryImmutableState(_factory, _WETH9) {
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        PoolAddress.PoolKey memory poolKey = _poolIdToPoolKey[position.poolId];
        IRabbitSwapV3Pool pool = IRabbitSwapV3Pool(PoolAddress.computeAddress(factory, poolKey));
