...
/// @title Callback for IRabbitSwapV3PoolActions#swap
/// @notice Any contract that calls IRabbitSwapV3PoolActions#swap must implement this interface
interface IRabbitSwapV3SwapCallback {
